...
namespace PluginAirWindows {
    ...
    public:   
        ...
        EffectImplMatrixVerb() {
            ...
            vibAL = rand.rng_double()*-2147483647;
            vibBL = rand.rng_double()*-2147483647;
            vibCL = rand.rng_double()*-2147483647;
            vibDL = rand.rng_double()*-2147483647;
            vibEL = rand.rng_double()*-2147483647;
            vibFL = rand.rng_double()*-2147483647;
            vibGL = rand.rng_double()*-2147483647;
            vibHL = rand.rng_double()*-2147483647;
            
            vibAR = rand.rng_double()*-2147483647;
            vibBR = rand.rng_double()*-2147483647;
            vibCR = rand.rng_double()*-2147483647;
            vibDR = rand.rng_double()*-2147483647;
            vibER = rand.rng_double()*-2147483647;
            vibFR = rand.rng_double()*-2147483647;
            vibGR = rand.rng_double()*-2147483647;
            vibHR = rand.rng_double()*-2147483647;
        ...
        void registerParams(std::vector<paramentry>& parameterTypes) override {
            parameterTypes.push_back({ 0, "Filter", "%", 1.0 });
            parameterTypes.push_back({ 1, "Damping", "%", 0.0f });
            parameterTypes.push_back({ 2, "Speed", "%", 0.0f });
            parameterTypes.push_back({ 3, "Vibrato", "%", 0.0f });
            parameterTypes.push_back({ 4, "RmSize", "%", 0.5f });
            parameterTypes.push_back({ 5, "Flavor", "%", 0.5f });
            parameterTypes.push_back({ 6, "Dry/Wet", "%", 0.5f });
        }
        void setParameters(internalplugin* plugin) override {
            ...
            F = plugin->getParamValue(PARAM_OFFSET_IMPL + 5);
            G = plugin->getParamValue(PARAM_OFFSET_IMPL + 6);
        }
        void processReplacing(float** inputs, float** outputs, samplecount_t sampleFrames, samplerate_t sampleRate) override {
            ...
            biquadC[0] = biquadB[0] = biquadA[0] = ((A * 9000.0) + 1000.0) / sampleRate;

            biquadA[1] = std::numbers::phi;
    ...
    IEffectImpl* createEffectImplMatrixVerb() {
        return new EffectImplMatrixVerb();
    }
}// namespace PluginAirWindows
