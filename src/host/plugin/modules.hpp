...
enum PluginType : int32_t {
    ...
    PLUGIN_TYPE_TAPE_DELAY,
    PLUGIN_TYPE_HOSTINFO = 1004,
    PLUGIN_TYPE_AIRWINDOWS_NONE = 2000,
    PLUGIN_TYPE_AIRWINDOWS_GALACTIC_1,
    PLUGIN_TYPE_AIRWINDOWS_GALACTIC_2,
    PLUGIN_TYPE_AIRWINDOWS_GALACTIC_3,
    PLUGIN_TYPE_AIRWINDOWS_MATRIXVERB,
    PLUGIN_TYPE_AIRWINDOWS_MAX = 2999, 
};
