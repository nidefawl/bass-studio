...
void renderAudioClip(NVGcontext* vg, waveformrender* wfrenderer, const guitheme_t* theme, const track_t* tr, const clip_t* cl, const audiofile_t* file, const gui_waveform_texture_ref* guiaudioclip, ivec2 pos, ivec2 size, ivec2 posClipped, ivec2 sizeClipped);
