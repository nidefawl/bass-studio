...
guictr_nodes_editor::guictr_nodes_editor(DAW::Cursor& _cursor, project_t& _project, dragdrop_file& _dragdropclip)
    : guictr_base(),
...
guictr_nodes_splitview::guictr_nodes_splitview(DAW::Cursor& _cursor, project_t& _project, dragdrop_file& _dragdropclip)
    : project(_project),
