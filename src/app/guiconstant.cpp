...
namespace GuiConstant {
constant_t CONST_SMALL_LABEL_HEIGHT("CONST_SMALL_LABEL_HEIGHT", 12);
...
constant_t CONST_FONT_SIZE_CONTEXT_MENU("CONST_FONT_SIZE_CONTEXT_MENU", 200);
constant_t CONST_LAYOUT_MARGIN("CONST_LAYOUT_MARGIN", 1);
}
