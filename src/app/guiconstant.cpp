...
namespace GuiConstant {
    ...
    constant_t CONST_FIXED_TITLE_HEIGHT("CONST_FIXED_TITLE_HEIGHT", 24, 4, 256);
    constant_t CONST_PLUGIN_TITLE_HEIGHT("CONST_PLUGIN_TITLE_HEIGHT", 24, 4, 256);
    constant_t CONST_TRACK_HEIGHT_STEP("CONST_TRACK_HEIGHT_STEP", 24 + INSET_TRACK_CONTENT * 2, 4, 256);
    constant_t CONST_TRACK_HEIGHT_TITLE("CONST_TRACK_HEIGHT_TITLE", 24 + INSET_TRACK_CONTENT * 2, 4, 128);
    constant_t CONST_METER_WIDTH("CONST_METER_WIDTH", 32, 4, 1024);
    constant_t CONST_FONT_SCALE("CONST_FONT_SCALE", 10, 1, 64);
    constant_t CONST_NODES_SCALE("CONST_NODES_SCALE", 10, 1, 1000);
