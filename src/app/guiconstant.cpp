...
namespace GuiConstant {
    ...
    constant_t CONST_MIXER_SIZE_STEP("CONST_MIXER_SIZE_STEP", 26);
    constant_t CONST_MIXER_WIDTH("CONST_MIXER_WIDTH", 200);
    constant_t CONST_NODES_SCALE("CONST_NODES_SCALE", 40);
    constant_t CONST_NOTE_RENDER_MODE("CONST_NOTE_RENDER_MODE", 1);
    constant_t CONST_PADDING_EDITOR_CONTROLS("CONST_PADDING_EDITOR_CONTROLS", 5);
    constant_t CONST_PADDING_TRACK_CONTROLS("CONST_PADDING_TRACK_CONTROLS", 1);
    constant_t CONST_PIANOROLL_STROKE_WIDTH("CONST_PIANOROLL_STROKE_WIDTH", 12);
    constant_t CONST_PLUGIN_TITLE_HEIGHT("CONST_PLUGIN_TITLE_HEIGHT", 40);
    constant_t CONST_ROW_HEIGHT("CONST_ROW_HEIGHT", 24);
    constant_t CONST_SMALL_LABEL_HEIGHT("CONST_SMALL_LABEL_HEIGHT", 20);
