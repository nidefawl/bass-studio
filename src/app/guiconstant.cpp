...
namespace GuiConstant {
    ...
    constant_t CONST_PADDING_EDITOR_CONTROLS("CONST_PADDING_EDITOR_CONTROLS", 2, 0, 32);
    ...
    constant_t CONST_ROW_HEIGHT("CONST_ROW_HEIGHT", 26, 8, 64);
    constant_t CONST_SMALL_LABEL_HEIGHT("CONST_SMALL_LABEL_HEIGHT", 20, 4, 256);
    constant_t CONST_FIXED_TITLE_HEIGHT("CONST_FIXED_TITLE_HEIGHT", 25, 4, 256);
    constant_t CONST_PLUGIN_TITLE_HEIGHT("CONST_PLUGIN_TITLE_HEIGHT", 26, 4, 256);

    constant_t CONST_TRACK_HEIGHT_STEP("CONST_TRACK_HEIGHT_STEP", 26, 4, 256);
    constant_t CONST_MIXER_SIZE_STEP("CONST_MIXER_SIZE_STEP", 26, 4, 256);
    ...
    constant_t CONST_METER_WIDTH("CONST_METER_WIDTH", 26, 20, 1000);
