...
namespace DAW::UI {
    ...
    void CommandManager::resetKeybinds() {
        ...
        Add(CMD_BUNDLE_PROJECT_DIRECTORY, {"Save Bundle (Directory)", "Bundle the project to a directory", "", ICON_SAVE}, {});
        Add(CMD_BUNDLE_PROJECT_ZIP, {"Save Bundle (zip)", "Bundle the project as zip file", "", ICON_SAVE}, {});
