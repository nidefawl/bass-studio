//
// Changes to nanovg code:
// Copyright (c) 2017-2022 Michael Hept
//
// Original nanovg code:
...
{
	NVGLUframebuffer* fb = (NVGLUframebuffer*) malloc(sizeof(NVGLUframebuffer));
	if (fb == NULL) 
		return NULL;
...
static const char* const NVG_GLSL_DEF_HEADER =
#if defined NANOVG_GL2
		"#define NANOVG_GL2 1\n"
#elif defined NANOVG_GL3
		"#version 150 core\n"
...
{
	dbgassert(ctx && shaderSrcVertex && shaderSrcFragment);
	GLNVGcontext* gl = (GLNVGcontext*)nvgInternalParams(ctx)->userPtr;
	dbgassert(gl);
