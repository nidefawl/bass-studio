...
find_library(ZLIB_RELEASE PATHS ${PROJECT_DEPS_INSTALL_PATH} REQUIRED NO_DEFAULT_PATH NAMES "zlibstatic" "z" PATH_SUFFIXES lib)
message(STATUS "ZLIB_RELEASE ${ZLIB_RELEASE}")

find_library(LIBARCHIVE_DEBUG PATHS ${PROJECT_DEPS_INSTALL_PATH} REQUIRED NO_DEFAULT_PATH NAMES "archive_static_debug" "archive_debug" PATH_SUFFIXES lib)
find_library(LIBARCHIVE_RELEASE PATHS ${PROJECT_DEPS_INSTALL_PATH} REQUIRED NO_DEFAULT_PATH NAMES "archive_static_release" "archive_release" PATH_SUFFIXES lib)
message(STATUS "LIBARCHIVE_DEBUG ${LIBARCHIVE_DEBUG}")
message(STATUS "LIBARCHIVE_RELEASE ${LIBARCHIVE_RELEASE}")
