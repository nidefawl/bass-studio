...
SetOutPath "$INSTDIR"
File /oname=${MAIN_APP_EXE} "${PROJ_LOC}\run\DAW-MSVC-relwithdebinfo.exe"
File /oname=daw-vstscanner.exe "${PROJ_LOC}\run\vstscanner-MSVC-relwithdebinfo.exe"
File "${PROJ_LOC}\run\soxr.dll"
SetOutPath "$INSTDIR\res"
File "${PROJ_LOC}\res\cursors.png"
...
File "${PROJ_LOC}\res\icons\synth_32px.png"
